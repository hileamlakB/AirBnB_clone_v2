...
def do_pack():
    ...
    try:
        ...
        loc3-deploy_web_static.pyal("if test ! -d ./versions; then mkdir versions;fi")
...
def do_deploy(archive_path):
    ...
    try:
        ...
        run("cp -r /data/web_static/releases/{}/web_static/* /data/web_static/releases/{}/".format(folder_name, folder_name))
        run("rm -fr /data/web_static/releases/{}/web_static/".format(folder_name))
